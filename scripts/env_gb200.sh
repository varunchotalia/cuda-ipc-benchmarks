...
# MPI_Init aborts -- the failure mode described at the top.
...
echo "env_gb200.sh: CUDA=$CUDA_HOME"
echo "env_gb200.sh: MPI =$MPI_HOME"
echo "env_gb200.sh: UCX =$HPCX_HOME/ucx/lib"
echo "env_gb200.sh: NVSHMEM=$NVSHMEM_HOME"
